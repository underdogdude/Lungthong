...
<script type="text/javascript"
	src="http://www.appelsiini.net/projects/chained/jquery.chained.js?v=0.9.10"></script>
...
<body id="timeline">
	<div class="container" >
		<div class="row navbar-fixed-top" id="top">
			...
			<a href="profile_setting.jsp"><img
				src="img/Topmenu/profile button.png" id="setting_icon"></a>
		</div>
		<form>
			<div id="search_menu">
				<div class="row">
					...
					<div class="col-xs-4">
						<button type="submit" class="btn-info btn-block btn-lg search_btn">
					...
					<c:forEach items="${rs.rows}" var="i">
						<div class="searchtopic row">
							<div class="col-xs-5" align="center">
								<a href=comment.jsp?id=${i.post_id}><img src="${i.pic}"
									class="thumbnail img-responsive" /></a>
							</div>
							<div class="col-xs-7">
								<h1 id="topic_name">
									<a href=comment.jsp?id=${i.post_id} style="color: black;">${i.head}</a>
								</h1>

								<span class="label label-info">${i.type}</span> <span
									class="label label-info">${i.style}</span> <span
									class="label label-info">${i.colour}</span>
